...
import fun.scop.app.isr.IsrSolverTj03

// import fun.scop.dsl._

case class IsrSolverTj03(p: IsrInstance, satsolver: SatSolver)
...
object IsrSolverTj03 {
  def main(args: Array[String]) = {
    ...
    val isrs = IsrSolverTj03(instance, satsolver)
